package com.ecomm.nhom4.Service.Entity;
...
public class Order {
    ...
    public Order(long idOrder, long idUser, List<Product> itemOrder, LocalDateTime ordered, OrderStatus status, int total, long idVoucher) {
